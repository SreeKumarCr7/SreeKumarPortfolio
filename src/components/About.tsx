          ...
          >
            <div className="prose prose-lg max-w-none">
              ...
              <div className="mt-8 p-6 bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl shadow-sm border border-gray-100">
                ...
                <div className="relative pl-8 border-l-2 border-indigo-200 space-y-10 before:absolute before:left-[-5px] before:top-0 before:w-2 before:h-2 before:rounded-full before:bg-indigo-600">
